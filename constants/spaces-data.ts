...
export const INITIAL_SPACES: Space[] = [
  {
    ...
    memberCount: 4,
    members: [
      { name: 'İrem', initials: 'İR' },
      { name: 'Mert', initials: 'ME' },
      { name: 'Bengisu', initials: 'BE' },
      { name: 'Mami', initials: 'MA' },
    ],
    recentActivity: "Mami voted on Cecconi's dinner poll",
  ...
  },
  {
    ...
    memberCount: 3,
    members: [
      { name: 'Dilek', initials: 'Dİ' },
      { name: 'Burak', initials: 'BU' },
      { name: 'Bora', initials: 'BO' },
    ],
    recentActivity: 'Burak added Oat Milk to market list',
  ...
  },
  {
    ...
    memberCount: 1,
    members: [
      { name: 'Eren', initials: 'ER' },
    ],
    recentActivity: "Eren added 'Saturday Jazz Night' plan",
